...
@section( 'content' )
     ...
     <div class="px-content">
        <div class="page-header">
            <h1><span class="text-muted font-weight-light"><i class="fa fa-certificate"></i>&nbsp;&nbsp;Political Group / </span>Add</h1>
        </div>
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="panel-title">Add Political Group</div>
                    </div>
                    ...
                    @endif
                        ...
                        {!! Form::open(['route' => 'admin.politicalGroups.store', 'id'=>'validation-form']) !!}
