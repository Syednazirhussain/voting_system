...
@section('content')
     ...
     <div class="px-content">
        <div class="page-header">
            <h1>
                <span class="text-muted font-weight-light"><i class="fa fa-users"></i>&nbsp;&nbsp;Participant</span> / Edit
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">{{ $participant->name }}</div>
                    </div>
                    ...
                    @endif
                       ...
                       {!! Form::model($participant, ['route' => ['admin.participants.update', $participant->id], 'method' => 'patch',  'id' => 'validation-form' ]) !!}
         ...
         'ssn': {
          ...
          messages: {
              ...
              'password': {
                ...
                rangelength: "Password should be minimum  6 characters in length"
              },
